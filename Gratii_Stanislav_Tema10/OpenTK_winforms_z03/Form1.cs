...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        private void LoadTextures() {
            ...
            LoadTexture(textures[0], "one-piece.png");
            LoadTexture(textures[1], "celovekPauk.png");
        ...
        private void DeseneazaCubQ_Tex1() {
            ...
            {
                // Ajustează coordonatele texturii pentru o suprafață non-rectangulară
                ...
                GL.TexCoord2(1.0, 0.5);  // Ajustează coordonatele texturii pentru o suprafață non-rectangulară
                GL.Vertex3(arrVertex[arrQuadsList[i + 2], 0], arrVertex[arrQuadsList[i + 2], 1], arrVertex[arrQuadsList[i + 2], 2]);

                GL.TexCoord2(0.0, 0.5);  // Ajustează coordonatele texturii pentru o suprafață non-rectangulară
        ...
        private void DeseneazaCubQ_Tex2() {
            ...
            for (int i = 0; i < nQuadsList; i += 4)
            {
                // Ajustează coordonatele texturii pentru întinderea pe orizontală
                GL.TexCoord2(0.0, 1.0);
                GL.Vertex3(arrVertex[arrQuadsList[i], 0], arrVertex[arrQuadsList[i], 1], arrVertex[arrQuadsList[i], 2]);

                GL.TexCoord2(2.0, 1.0); // Ajustează coordonatele texturii pentru întinderea pe orizontală
                GL.Vertex3(arrVertex[arrQuadsList[i + 1], 0], arrVertex[arrQuadsList[i + 1], 1], arrVertex[arrQuadsList[i + 1], 2]);

                GL.TexCoord2(2.0, 0.0); // Ajustează coordonatele texturii pentru întinderea pe orizontală
                GL.Vertex3(arrVertex[arrQuadsList[i + 2], 0], arrVertex[arrQuadsList[i + 2], 1], arrVertex[arrQuadsList[i + 2], 2]);
